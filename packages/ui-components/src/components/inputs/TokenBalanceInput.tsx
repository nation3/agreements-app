	...
	return (
		<div className="flex">
			<input
				type="text"
				id="balance-input"
				className={`rounded-none rounded-l-lg bg-gray-50 border text-gray-900 focus:ring-${focusColor} focus:border-${focusColor} block flex-1 min-w-0 w-full text-sm border-gray-300 p-2.5`}
